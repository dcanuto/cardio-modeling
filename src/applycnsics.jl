function applycnsics!(system::CVSystem)
    ...
    system.cns.gammaC4L = 0.6*system.cns.C4L[1];
    system.cns.alphaC4L = 2.2*system.cns.C4L[1] - system.cns.gammaC4L;
    system.cns.gammaC5L = 0.6*system.cns.C5L[1];
    system.cns.alphaC5L = 2.2*system.cns.C5L[1] - system.cns.gammaC5L;
    system.cns.gammaC4U = 0.6*system.cns.C4U[1];
    system.cns.alphaC4U = 2.2*system.cns.C4U[1] - system.cns.gammaC4U;
    system.cns.gammaC5U = 0.6*system.cns.C5U[1];
    system.cns.alphaC5U = 2.2*system.cns.C5U[1] - system.cns.gammaC5U;
    system.cns.gammaV4L = 0.6*system.cns.V4L[1];
    system.cns.alphaV4L = 2.2*system.cns.V4L[1] - system.cns.gammaV4L;
    system.cns.gammaV5L = 0.6*system.cns.V5L[1];
    system.cns.alphaV5L = 2.2*system.cns.V5L[1] - system.cns.gammaV5L;
    system.cns.gammaV4U = 0.6*system.cns.V4U[1];
    system.cns.alphaV4U = 2.2*system.cns.V4U[1] - system.cns.gammaV4U;
    system.cns.gammaV5U = 0.6*system.cns.V5U[1];
    system.cns.alphaV5U = 2.2*system.cns.V5U[1] - system.cns.gammaV5U;
